...
if emulators_running:
    ...
    from controllers.users_controller import update_user, create_new_user, get_existing_user, delete_user, delete_transactions
...
__all__ = ['create_new_user', 'update_user', 'get_existing_user', 'delete_user', 'delete_transactions', process_receipt]